<template>
	<view class="page">
		...
		<view class="input-t ">
			<text>开始时间</text>
			<picker mode="date" :value="sendDate.begin_date" @change="bindDateChange">
		...
		<view class="input-t ">
			<text>结束时间</text>
			<picker mode="date" :value="sendDate.end_date" @change="bindEndDateChange">
				<view class="date" style="background: none;">{{
					end_date || '请选择日期'
				}}</view>
			</picker>
