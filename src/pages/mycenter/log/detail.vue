<template>
	<view class="page">
		<!-- <view class="input-t" @tap.stop="chooseType">
			<text>日志类型</text>
			<text class="input-quick">{{ mtype || '请选择日志类型' }} <text class="iconfont iconxia"></text></text>
		</view> -->
		<view class="input-t ">
			<text>类型</text>
			<view class="tit">
...
<script>
// import { log,getLogType } from '@/api/basic';
...
// 			this.sendDate.type = this.mtypeValue;
// 			await this.$http
// 					.put(`${log}/update?id=${this.id}`, {
// 					...this.sendDate
// 				})
// 				.then(() => {
