	...
	<view class="feedback-list">
		<view class="oa-list">
			<view class="oa-list-item" @tap="navTo(`/pages/set/feedback/detail?id=1`)">
				<view class="wrapper">
					<view class="address-box">
						<text class="tag" :class="'text-' + pageStore.$state.themeColor.name">{{ 1 | feedbackFilter }}</text>
			...
			<view class="oa-list-item" @tap="navTo(`/pages/set/feedback/detail?id=1`)">
				<view class="wrapper">
					<view class="address-box">
						<text class="tag" :class="'text-' + pageStore.$state.themeColor.name">{{ 2 | feedbackFilter }}</text>
			...
			<view class="oa-list-item" @tap="navTo(`/pages/set/feedback/detail?id=1`)">
				<view class="wrapper">
					<view class="address-box">
						<text class="tag" :class="'text-' + pageStore.$state.themeColor.name">{{ 3| feedbackFilter }}</text>
		...
		<view class="add-btn-wrapper">
			<button class="add-btn" :class="'bg-' + pageStore.$state.themeColor.name" @tap="navTo(`/pages/set/feedback/feedback`)">
				意见反馈
			</button>
		</view>
